...
class BookingsFilter(backend_filters.FilterSet):
    ...
    previous_date_booking = backend_filters.DateFilter(field_name='booking_date', lookup_expr='lte')
    upcoming_date_booking = backend_filters.DateFilter(field_name='booking_date', lookup_expr='gte')
    ...
    class Meta:
        ...
        fields = [
            'name', 'description',
                  'booking_status',
                  'max_price', 'min_price',
                  'previous_date_booking',
                  'upcoming_date_booking','user']
